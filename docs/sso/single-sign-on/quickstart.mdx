...
This quickstart guide will show you how to implement Single Sign-on (SSO). Scalekit is an authentication platform that connects your application to any of your customers identity providers and enabling your users to login to your application via SAML or OpenID Connect protocols.
