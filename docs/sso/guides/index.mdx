...
<CardList size="medium">
  ...
  <Card title="Auth0" href="k/sso/guides/key-concepts/authorization-url" linkText="Explore">

  </Card>
  <Card title="Firebase" href="/sso/guides/key-concepts/redirect-uri" linkText="Explore">
