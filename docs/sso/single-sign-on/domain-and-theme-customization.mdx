...
- Organization users will see this URL in their browser’s address when they visit the [Admin Portal](/sso/single-sign-on/quickstart-admin-portal) to configure authentication settings.
- Organization users logging into the app using [SSO via SAML](/sso/guides/integrations/saml) (or) [SSO via OIDC](/sso/guides/integrations/oidc) will see this URL in the browser's address bar as part of redirections to their Identity Providers.
