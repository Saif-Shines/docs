...
# Launch Checklist
<Subtitle>Check off these recommended steps before launching your app in Production</Subtitle>
...
<LabeledCheckbox id="5"> **Review Admin Portal URL:** </LabeledCheckbox> Customize the admin portal URL to match your domain (for example, <SimpleCode>https:<nolink />//sso.b2b-app.com </SimpleCode>) for a seamless brand experience. Also, Remember to update <SimpleCode>.env</SimpleCode> file post-CNAME configuration.
